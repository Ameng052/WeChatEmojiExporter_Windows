...
BINARIES = [(str(FFMPEG_EXE), r'tools\ffmpeg\ffmpeg-master-latest-win64-gpl\bin')] if FFMPEG_EXE else []
DATAS = [(str(WECHAT_SETUP), r'.')] if WECHAT_SETUP else []
